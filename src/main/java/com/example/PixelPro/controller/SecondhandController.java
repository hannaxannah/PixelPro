...
public class SecondhandController {
    ...
    public String gotoSecondhandBoard(
        ...
        System.out.println(shcategory+"/"+keyword);
        ...
        Page<SecondhandEntity> secondhandBoardList = secondhandService.getListsBySearch(map, Integer.valueOf(pageNumber)-1);
    ...
    public String gotoWriteSecondhandBoard(Model model){
        //아이디 정보 넘겨오기
        //아이디 정보 보내기
        model.addAttribute("secondhandBean", new SecondhandBean());
